...
**Version:** 0.2  
**Status:** Revised product and build blueprint  
**Revision focus:** CTD authoring, source-to-section mapping, dossier consistency, reviewer readiness, and Codex implementation workflow  
...
### 3.4 Research-Informed Practitioner Pain Points

Qualitative practitioner research indicates that the most difficult submission work is not merely formatting or tracking documents. Recurring pain points include:

1. **Content judgment:** deciding what belongs in a submission, what does not belong, and which official or program-specific source controls.
2. **Source readiness:** technical source reports may exist in inconsistent versions, remain unapproved, or fail to support final authoring.
3. **Regulatory narrative:** subject-matter experts provide facts, but Regulatory Affairs must connect development decisions, risks, controls, evidence, and conclusions into one coherent story.
4. **Cross-module consistency:** repeated facts such as manufacturing sites, batch sizes, specifications, study identifiers, cut-off dates, and labeling claims can diverge across modules.
5. **Late changes:** changes to source data or strategy can force repeated rewriting, review, cross-reference repair, hyperlink repair, and publishing QC.
6. **Reviewer readiness:** a technically complete dossier can still be difficult to review if the rationale, traceability, and internal consistency are weak.
7. **Precedent research:** teams frequently review labels, approval packages, assessment reports, prior agency feedback, and comparable products while recognizing that precedent is contextual rather than binding.
8. **Tool skepticism:** practitioners are unlikely to adopt another generic milestone tracker that does not improve content decisions or evidence traceability.
9. **LLM trust:** users want fast retrieval and explanation but do not trust unconstrained language models to make deterministic regulatory decisions.

These findings lead to a product rule:

> The platform must help users decide what content belongs in each CTD section, identify the evidence that supports it, and test whether the complete dossier tells a consistent and reviewable regulatory story.

### 3.5 CTD Structural Limitation

The Common Technical Document primarily standardizes **where information is organized**. It does not independently determine the full type and extent of evidence required for every product.

The product must therefore combine five layers:
...
A CTD section page must never imply that the section heading alone defines all required evidence.
...
│   ├── CTD Authoring & Dossier Builder
│   │   ├── FDA Module 1 Builder
│   │   ├── EMA Module 1 Builder
│   │   ├── Module 2 Authoring Guide
│   │   ├── Module 3 Quality Authoring Guide
│   │   ├── Module 4 Nonclinical Authoring Guide
│   │   ├── Module 5 Clinical Authoring Guide
...
Help users identify the categories of documents, evidence, procedural steps, and cross-functional readiness activities that may apply to a submission, and then help authors determine what information belongs in each CTD section, which source documents support it, and whether the dossier is internally consistent and reviewer-ready.
...
The CTD Authoring & Dossier Builder is not a blank document template and must not automatically fabricate regulatory prose. It is a structured authoring-support environment that helps users:

- understand the purpose of a CTD section;
- determine the information normally expected in that section;
- identify underlying source documents and data;
- assign owners and contributors;
- identify dependencies and unresolved questions;
- connect claims to evidence;
- reconcile repeated facts across modules;
- anticipate reviewer questions;
- determine whether final authoring should begin;
- preserve traceability when source documents change.

#### Core User Flow

```text
Choose agency and application
    ↓
Choose CTD module and section
    ↓
Review section purpose and applicable source hierarchy
    ↓
Complete applicability questions
    ↓
Build source-document inventory
    ↓
Identify missing or unapproved evidence
    ↓
Generate authoring packet
    ↓
Draft and review outside or inside the future workspace
    ↓
Run consistency and reviewer-readiness checks
    ↓
Approve section readiness
```
...
Module 1 must be implemented separately for FDA and EMA because it is not harmonized.
...
- labeling;
- patent and exclusivity material where applicable;
- environmental documentation;
- financial disclosure;
- regional certifications and correspondence.
...
- product information;
- expert information;
- EU declarations and annexes;
- orphan-related documentation;
- pharmacovigilance information;
- paediatric documentation;
- environmental risk documentation;
- centralised-procedure working documents.

The interface must prevent FDA and EMA Module 1 requirements from being mixed.
...
```text
Overview = critical interpretation, regulatory argument, benefits, risks, limitations, and unresolved issues
Summary = detailed integrated factual presentation
Modules 3–5 = underlying evidence and reports
```
...
Module 3 is the first implementation priority because it connects directly to CMC lifecycle work, post-approval changes, inspection readiness, and labeling implementation.

##### Module 4 — Nonclinical Study Reports

The builder should organize:
...
- toxicokinetics;
- literature;
- study-level reports and supporting data.

It must connect Module 4 evidence to Modules 2.4 and 2.6.
...
- postmarketing experience where applicable;
- case-report forms and patient-level listings where required;
- literature.

It must connect study evidence to Modules 2.5, 2.7, integrated analyses, and proposed labeling claims.

#### Standard CTD Section Record

Every CTD section must use a standard record:

```yaml
section_id: "3.2.P.5"
title: "Control of Drug Product"
module: 3
substance_or_product: "drug_product"
...
#### Section Detail Page Requirements

Every CTD section page must display:

1. Regulatory purpose
2. What belongs here
3. What normally belongs elsewhere
4. Applicability and conditional questions
5. Required or expected source documents
6. Required or expected source data
7. Primary owner, contributors, and approvers
8. Dependencies and prerequisite decisions
9. Authoring questions
10. Questions to send to SMEs
11. Expected tables and figures
12. Cross-references
13. Consistency checks
14. Common deficiencies
15. Reviewer lens
16. Inspection relevance
17. Readiness status
18. Official sources, source status, and last verification
19. Limitations and product-specific confirmation needs

#### Authoring Readiness

A section must have a readiness assessment separate from drafting progress.

```text
Not ready
- critical source documents are missing;
- key technical strategy is unresolved;
- required source documents are not approved;
- source versions conflict.

Ready for initial drafting
- core evidence exists;
- known gaps are documented;
- owners are assigned;
- preliminary strategy is stable.

Ready for final authoring
- source documents are approved;
- key decisions are final;
- cross-references are known;
- data cut-off is confirmed.

Reviewer ready
- comments are closed;
- claims are traceable;
- cross-module consistency checks pass;
- citations and source versions are reconciled.
```
...
> Show which source report or controlled document supplies which CTD section and what content is extracted.
...
> Connect a regulatory claim or conclusion to the supporting data, dossier location, proposed labeling, limitations, and residual risk.
...
claim_id: ""
claim_text: ""
claim_type: "quality | nonclinical | clinical | labeling"
supporting_evidence: []
ctd_locations: []
labeling_locations: []
limitations: []
...
The checker should compare repeated facts without silently deciding which value is correct.

Initial data points:

- product and substance names;
- dosage form;
- strengths;
...
- analytical procedure names and versions;
- reference standards;
- shelf life and storage;
- container-closure descriptions;
- study identifiers;
- database lock and cut-off dates;
- analysis populations;
- efficacy and safety values;
- proposed labeling terminology.
...
Intentional difference with justification
Unable to compare
```

#### Reviewer Readiness Lens

Each section should show:

- what the reviewer is trying to determine;
- which missing information may prevent substantive review;
- likely clarification questions;
- unsupported conclusions;
- cross-module dependencies;
- inspection implications;
- product-specific facts that may change the expectation.

The reviewer lens must be clearly labeled as educational decision support and not an agency-issued completeness determination.

#### Authoring Packet Generator

The assistant should initially generate an authoring packet rather than finished regulatory prose:

```text
Section purpose
Applicable source hierarchy
Proposed outline
...
The system may later assist drafting, but it must not invent data or represent generated prose as approved submission content.

#### Late-Change Impact

When a source fact changes, the system should identify:

- affected CTD sections;
- Module 2 summaries or overviews that must be reopened;
- affected tables and figures;
- impacted labeling;
- inspection traceability;
- cross-references and hyperlinks;
- review and publishing steps that must be repeated.

#### M4Q Revision Readiness

The current product must use the applicable M4Q(R1) structure. It may maintain a separate future-readiness model for draft M4Q(R2) concepts, but it must never mix a draft future framework into current mandatory checklists.

Display:

```text
Current applicable structure: M4Q(R1)
Future-readiness preview: Draft M4Q(R2) — not current mandatory content
```

#### CTD MVP Sequence

1. Module 3 Drug Product
   - 3.2.P.1
   - 3.2.P.2
   - 3.2.P.3
   - 3.2.P.5
   - 3.2.P.7
   - 3.2.P.8
   - linked 2.3 Quality Overall Summary
2. Separate FDA and EMA Module 1 readiness
3. Clinical authoring and claim-to-evidence traceability
4. Nonclinical authoring
5. Full cross-module consistency and reviewer-readiness workflow

### Initial MVP Coverage

Do not build every submission family simultaneously.

#### MVP 1A — CTD Authoring Foundation

- CTD Authoring & Dossier Builder landing page
- Module 3 Drug Product navigation
- complete section model for 3.2.P.5 as the reference implementation
- source-to-CTD matrix
- authoring-readiness status
- cross-module consistency-check framework
- reviewer-readiness lens
- linked 2.3 Quality Overall Summary relationship

#### MVP 1B — Submission and Regional Readiness

- FDA original NDA high-level readiness
- FDA Module 1 and labeling package
- FDA eCTD publishing readiness
- EMA centralised MAA high-level readiness
- EMA Module 1 and pre-submission procedural readiness
...
/
 ...
 /submission-navigator/ctd/module-1/fda
 /submission-navigator/ctd/module-1/ema
 /submission-navigator/ctd/module-2
 /submission-navigator/ctd/module-3
 /submission-navigator/ctd/module-3/drug-product
 /submission-navigator/ctd/module-3/drug-product/[section]
 /submission-navigator/ctd/module-4
 /submission-navigator/ctd/module-5
 /submission-navigator/ctd/source-matrix
 /submission-navigator/ctd/consistency-check
 /submission-navigator/ctd/reviewer-readiness
...
- CTD Authoring & Dossier Builder landing page;
- Module 3 Drug Product navigation;
- section-detail data schema;
- 3.2.P.5 reference implementation;
- source-to-CTD matrix;
- section authoring-readiness model;
- claim-to-evidence model;
- consistency-check framework;
- reviewer-readiness lens;
- linked Module 2.3 relationship;
- downloadable authoring packet;
- source and content versioning;
- tests for schema, citations, and consistency rules.

Exit criteria:

- the section purpose, expected information, source documents, ownership, dependencies, and reviewer questions are visible;
- missing or unapproved sources block final-readiness status;
- the product does not generate invented technical content;
- all sample regulatory content is source-linked and human-reviewed;
- a user can trace source evidence into the CTD section and export an authoring packet.
...
## Phase 7 — User Accounts and Commercial Validation
...
- [ ] Downloadable templates
- [ ] CTD Authoring & Dossier Builder landing page
- [ ] Module 3 Drug Product section schema
- [ ] 3.2.P.5 reference section page
- [ ] Source-to-CTD matrix prototype
...
The first coding milestone should be an end-to-end vertical slice that proves the CTD architecture without attempting to author an entire NDA or MAA.
...
4. A fully implemented reference page for **3.2.P.5 Control of Drug Product**
5. Source-to-CTD Matrix prototype
6. Methodology/disclaimer panel linked from every CTD page

### 3.2.P.5 Reference Page

The page must include:

- regulatory purpose;
- scope boundary;
- expected and conditional information;
- source documents and source data;
- owners and contributors;
- prerequisites and dependencies;
- authoring and SME questions;
- expected tables;
- cross-references;
- consistency checks;
- common deficiencies;
...
- readiness status;
- citations, source status, and last verification;
- educational-use limitation.

### Interactive Behavior

- expand/collapse information groups;
- filter source documents by status;
- display missing and unapproved source counts;
- calculate readiness state using deterministic rules;
- show unresolved questions;
- export or print an authoring packet;
- navigate to related CTD sections;
- work without login or confidential data.

### Data and Architecture

- typed CTD section schema;
- structured sample section data;
- source-document schema;
- readiness evaluator;
- citation component;
- test fixtures;
- no regulatory business logic hidden only in UI components.
...
- missing-source case;
- unapproved-source case;
- reviewer-ready case;
- citation-required test;
- accessibility and route smoke test;
- production build.

### Why Start Here

- it addresses the researched content-authoring problem rather than only document tracking;
- it creates the reusable data model for all CTD modules;
- it connects submission readiness, change impact, inspection readiness, and labeling;
- it is narrow enough to review rigorously;
- it gives recruiters and early users a meaningful working demonstration.

### Next Slice After Approval

After the reference implementation is reviewed:

1. add 3.2.P.1, 3.2.P.2, 3.2.P.3, 3.2.P.7, and 3.2.P.8;
2. add linked 2.3 Quality Overall Summary;
3. add cross-module consistency rules;
4. connect Module 3 sections to Change Impact Navigator;
5. connect dossier statements to inspection evidence.
...
## CTD and Authoring Framework

19. ICH, **M4: The Common Technical Document**  
    https://www.ich.org/page/ctd

20. ICH, **M4Q(R1): Quality**  
    https://database.ich.org/sites/default/files/M4Q_R1_Guideline.pdf

21. ICH, **M4E(R2): Efficacy**  
    https://database.ich.org/sites/default/files/M4E_R2__Guideline.pdf

22. FDA, **NDA and BLA Filing Review Checklists**  
    https://www.fda.gov/media/87035/download

23. EMA, **Pre-authorisation Guidance and Validation Resources**  
...
# 28. Revision 0.2 Summary

This revision adds the research-backed CTD Authoring & Dossier Builder as a first-class product area.

Major changes:

- expanded practitioner pain-point model;
- clarified that CTD structure alone does not determine all evidence requirements;
- added separate FDA and EMA Module 1 builders;
- added section-level authoring schema;
- added source-to-CTD and claim-to-evidence matrices;
- added authoring-readiness states;
- added cross-module consistency checking;
- added reviewer-readiness lens;
- added late-change impact;
- added M4Q(R2) future-readiness separation;
- changed the first coding slice to a Module 3 Drug Product vertical implementation;
- added CTD-specific routes, repository structure, backlog, tests, and references.
